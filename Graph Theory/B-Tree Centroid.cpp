...
struct graph1 {
   ...
   *
   * The centroid of a tree is the node with the minimum value of its maximum
   * subtree size. A tree could have up to 2 centroids.
   *
   * if the second element is 0, then only the first element is the valid
   * centroid.
   *
   * Test: POJ1655
   */
