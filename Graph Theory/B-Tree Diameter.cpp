...
struct graph1
{
   ...
   * 
   * The function diameter() implemented DP on tree to calculate the top-2 longest path in the subtree, which could later merge into a legal path.
   * The diameter is always equal to the longest path on the tree.
   */
  WeTy diameter()
  {
