 ...
 * - 1 x y z : add z to all nodes on the shortest path from x-th node to y-th node.
 * - 2 x y   : query the sum of all nodes on the shortest path from x-th node to y-th node.
